...
//це спосіб отримати окремі значення зі складних даних, таких як масиви або об'єкти. Можна легко отримати доступ до окремих елементів масиву або властивостей об'єкта, необхідних для подальшої роботи з даними
...
const user1 = {
  ...
  const { name: fName, years: age, isAdmin = false } = user1;
